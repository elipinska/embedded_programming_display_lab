...
export LoadConfigTBL_displaylab_Bank1
export LoadConfigTBL_displaylab_Bank0
export LoadConfigTBL_displaylab_Ordered
AREA lit(rom, rel)
LoadConfigTBL_displaylab_Bank0:
;  Global Register values Bank 0
	...
	db		ffh
LoadConfigTBL_displaylab_Bank1:
...
LoadConfigTBL_displaylab_Ordered:
