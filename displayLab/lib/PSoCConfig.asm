...
export LoadConfig_displaylab
export _LoadConfig_displaylab
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_displaylab
	lcall	LoadConfigTBL_displaylab_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration displaylab
;
;    Load configuration registers for displaylab.
...
;               CUR_PP
;
_LoadConfig_displaylab:
 LoadConfig_displaylab:
    RAM_PROLOGUE RAM_USE_CLASS_4
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_displaylab_Bank0
    mov     X, <LoadConfigTBL_displaylab_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_displaylab_Bank1
    mov     X, <LoadConfigTBL_displaylab_Bank1
